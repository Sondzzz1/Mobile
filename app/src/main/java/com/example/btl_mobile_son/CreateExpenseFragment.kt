...
class CreateExpenseFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val danhMucChi = listOf("Sửa chữa", "Điện", "Nước", "Vệ sinh", "Bảo trì", "Lương", "Khác")
        spinnerDanhMuc.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_dropdown_item, danhMucChi)
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                withContext(Dispatchers.Main) {
                    gd?.let {
                        ...
                        val idx = danhMucChi.indexOfFirst { dm -> dm == it.danhMuc }
        ...
        btnLuu.setOnClickListener {
            ...
            val giaoDich = GiaoDich(
                ...
                loai = "chi",
                soTien = soTien,
                danhMuc = danhMucChi[spinnerDanhMuc.selectedItemPosition],
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                withContext(Dispatchers.Main) {
                    Toast.makeText(context, "Đã lưu khoản chi", Toast.LENGTH_SHORT).show()
                    requireActivity().onBackPressed()
                }
            }
        }

...
class DanhSachHoaDonFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            android.util.Log.e("DanhSachHoaDonFragment", "Error initializing database", e)
        ...
        view.findViewById<Button>(R.id.btnCreateInvoice).setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, TaoHoaDonFragment())
    ...
    private fun taiDuLieu(view: View) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                android.util.Log.e("DanhSachHoaDonFragment", "Error loading data", e)
                withContext(Dispatchers.Main) {

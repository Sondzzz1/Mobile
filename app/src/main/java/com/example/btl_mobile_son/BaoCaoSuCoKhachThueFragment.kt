...
class BaoCaoSuCoKhachThueFragment : Fragment() {
            ...
            try {
                val data = withContext(Dispatchers.IO) {
                    try {
                        ...
                        android.util.Log.e("BaoCaoSuCoKhachThue", "Error loading data", e)
                        Pair(0, emptyList())
                    }
                }
                ...
                android.util.Log.e("BaoCaoSuCoKhachThue", "Error in loadRoomAndIssues", e)

...
class CreateUtilityFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            android.util.Log.e("CreateUtilityFragment", "Error initializing database", e)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                // VĐ5: Listener cho phòng - tự động load chỉ số cũ từ tháng trước (xử lý đúng tháng 1)
                    ...
                    override fun onItemSelected(parent: AdapterView<*>?, v: View?, pos: Int, id: Long) {
                        if (danhSachPhong.isNotEmpty() && maChiSoEdit <= 0) {
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                ...
                                // VĐ5: Sử dụng hàm layChiSoThangTruoc() đã xử lý đúng logic tháng 1
                ...
                // VĐ5: Listener cho loại dịch vụ - cập nhật chỉ số cũ khi đổi loại
    ...
    private suspend fun luuChiSo(chiSo: ChiSoDienNuoc, maPhong: Long, loai: String, thang: Int, nam: Int) {
        ...
        withContext(Dispatchers.Main) {
            ...
            // VĐ6: Chỉ gợi ý tạo hóa đơn khi đã có đủ cả điện và nước
            CoroutineScope(Dispatchers.IO).launch {

...
class HoTroCoSoDuLieu(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        android.util.Log.d("HoTroCoSoDuLieu", "onCreate started")
        
        android.util.Log.d("HoTroCoSoDuLieu", "Creating database tables...")
        
        android.util.Log.d("HoTroCoSoDuLieu", "Creating TABLE_NHA_TRO...")
        db.execSQL("""
        ...
        """)
        android.util.Log.d("HoTroCoSoDuLieu", "TABLE_NHA_TRO created")

        android.util.Log.d("HoTroCoSoDuLieu", "Creating TABLE_PHONG...")
        db.execSQL("""
        ...
        """)
        android.util.Log.d("HoTroCoSoDuLieu", "TABLE_PHONG created")
        ...
        android.util.Log.d("HoTroCoSoDuLieu", "Creating TABLE_NGUOI_DUNG...")
        db.execSQL("""
        ...
        """)
        android.util.Log.d("HoTroCoSoDuLieu", "TABLE_NGUOI_DUNG created")
        ...
        """)
        android.util.Log.d("HoTroCoSoDuLieu", "onCreate completed")
    }

    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        android.util.Log.d("HoTroCoSoDuLieu", "Upgrading database from $oldVersion to $newVersion")
        ...
        onCreate(db)
        android.util.Log.d("HoTroCoSoDuLieu", "onUpgrade completed")
    }
    
    override fun onDowngrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        android.util.Log.d("HoTroCoSoDuLieu", "Downgrading database from $oldVersion to $newVersion")
        db.execSQL("DROP TABLE IF EXISTS $TABLE_NGUOI_DUNG")
        db.execSQL("DROP TABLE IF EXISTS $TABLE_SU_CO")
        db.execSQL("DROP TABLE IF EXISTS $TABLE_GIAO_DICH")
        db.execSQL("DROP TABLE IF EXISTS $TABLE_CHI_TIET_HOA_DON")
        ...
        onCreate(db)
        android.util.Log.d("HoTroCoSoDuLieu", "onDowngrade completed")
    }
    ...
    override fun onOpen(db: SQLiteDatabase) {
        super.onOpen(db)
        android.util.Log.d("HoTroCoSoDuLieu", "Database onOpen called")
    }
}

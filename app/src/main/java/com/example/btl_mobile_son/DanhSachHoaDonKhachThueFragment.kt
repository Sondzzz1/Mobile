...
class DanhSachHoaDonKhachThueFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            android.util.Log.e("DanhSachHoaDonKhachThue", "Error in onViewCreated", e)
            ...
            try {
                val invoices = withContext(Dispatchers.IO) {
                    try {
                        ...
                        android.util.Log.e("DanhSachHoaDonKhachThue", "Error loading invoices", e)
                        emptyList()
                    }
                }
                ...
                android.util.Log.e("DanhSachHoaDonKhachThue", "Error in loadInvoices", e)

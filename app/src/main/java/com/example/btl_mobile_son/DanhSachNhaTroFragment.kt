...
class DanhSachNhaTroFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            android.util.Log.e("DanhSachNhaTroFragment", "Error initializing database", e)
        ...
        adapter = NhaTroAdapter(
            ...
            onItemClick = { nha ->
                ...
                val fragment = DanhSachPhongFragment().apply {
            ...
            onEditClick = { nha ->
                // Mở fragment edit
                val fragment = TaoNhaTroFragment().apply {
                    arguments = Bundle().apply { putLong("maNha", nha.maNha) }
                }
                parentFragmentManager.beginTransaction()
                    .replace(R.id.fragment_container, fragment)
        ...
        view.findViewById<Button>(R.id.btnCreateHouse).setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, TaoNhaTroFragment())
                .addToBackStack(null).commit()
        }
    ...
    private fun taiDuLieu(view: View) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                android.util.Log.e("DanhSachNhaTroFragment", "Error loading data", e)
                withContext(Dispatchers.Main) {

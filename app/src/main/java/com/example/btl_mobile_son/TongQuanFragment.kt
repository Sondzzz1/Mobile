...
class TongQuanFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        android.util.Log.d("TongQuanFragment", "onViewCreated started")
        
        try {
            dbManager = DatabaseManager.getInstance(requireContext())
            android.util.Log.d("TongQuanFragment", "DatabaseManager initialized successfully")
        } catch (e: Exception) {
            android.util.Log.e("TongQuanFragment", "Error initializing DatabaseManager", e)
            e.printStackTrace()
            return
        }
    ...
    private fun loadStatistics(view: View) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                android.util.Log.e("TongQuanFragment", "Error loading statistics", e)
                e.printStackTrace()
                withContext(Dispatchers.Main) {
    ...
    private suspend fun checkWarnings() {
        try {
            ...
            android.util.Log.e("TongQuanFragment", "Error checking warnings", e)
        }
    }

...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun register(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                android.util.Log.d("RegisterActivity", "Attempting to register: $username")
                ...
                if (existingTenant != null) {
                    android.util.Log.d("RegisterActivity", "Username already exists: $username")
                ...
                android.util.Log.d("RegisterActivity", "Registration result ID: $result")
                
                // Verify the tenant was saved
                val savedTenant = dbManager.khachThueDao.dangNhap(username, password)
                android.util.Log.d("RegisterActivity", "Verification: ${savedTenant != null}")

...
class TenantMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            // Kiểm tra session - nếu chưa đăng nhập hoặc không phải tenant, chuyển về LoginActivity
            ...
            // Nếu là admin, chuyển sang MainActivity
            ...
            // Chỉ tenant mới vào TenantMainActivity
            ...
            bottomNav.setOnItemSelectedListener { item ->
                try {
                    ...
                    android.util.Log.e("TenantMainActivity", "Error loading fragment", e)
            ...
            android.util.Log.e("TenantMainActivity", "Error in onCreate", e)
    ...
    private fun loadFragment(fragment: Fragment) {
        try {
            ...
            android.util.Log.e("TenantMainActivity", "Error in loadFragment", e)

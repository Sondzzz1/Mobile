...
class DanhSachHopDongFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            android.util.Log.e("DanhSachHopDongFragment", "Error initializing database", e)
        ...
        adapter = HopDongAdapter(
            danhSach = emptyList(),
            onItemClick = { hopDong ->
                val fragment = TaoHopDongFragment().apply {
        ...
        view.findViewById<Button>(R.id.btnAddContract).setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, TaoHopDongFragment())
                .addToBackStack(null).commit()
        }
    ...
    private fun taiDuLieu(view: View) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                android.util.Log.e("DanhSachHopDongFragment", "Error loading data", e)
                withContext(Dispatchers.Main) {
